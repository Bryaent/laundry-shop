...
<li><fieldset>
    ...
    <ol>
    <li><input type="radio" name="modepayment" value="credit">Credit Card</li>
    <li><input type="radio" name="modepayment" value="cash">Cash</li>
    <li><input type="radio" name="modepayment" value="gcash">GCash</li>
    </ol>
</fieldset>

      <li>Account Number<input type="text" name = "accountnumber" size = "30" placeholder="Account Number"></li>
      <li>Account Name<input type="text" name = "accountname" size = "15" placeholder="Account Name"></li>
